...
describe('footnotes', function() {
  it('render (basic)', function() {
    ...
    content.should.equal(
      ...
      '<li id="fn:5" style="list-style: none">' +
      ...
      '<a href="#fnref:5" rev="footnote" style="margin-left: 6px">&#8617;</a></span></li></ol></div></div>'
    );
  });
  ...
  it('render (random number)', function() {
    ...
    content.should.equal(
      ...
      '<div id="footnotelist">' +
      '<ol style="list-style: none; padding-left: 0; margin-left: 40px">' +
      '<li id="fn:13" style="list-style: none">' +
      '<span style="display: inline-block; vertical-align: top; padding-right: 10px; margin-left: -40px">' +
      '13.' +
      '</span>' +
      '<span style="display: inline-block; vertical-align: top; margin-left: 10px">' +
      'basic footnote content' +
      '<a href="#fnref:13" rev="footnote" style="margin-left: 6px">&#8617;</a></span></li></ol></div></div>'
    );
  });
  ...
  it('render (inline footnote)', function() {
    ...
    content.should.equal(
      ...
      '<div id="footnotelist">' +
      '<ol style="list-style: none; padding-left: 0; margin-left: 40px">' +
      '<li id="fn:2" style="list-style: none">' +
      '<span style="display: inline-block; vertical-align: top; padding-right: 10px; margin-left: -40px">' +
      '2.' +
      '</span>' +
      '<span style="display: inline-block; vertical-align: top; margin-left: 10px">' +
      'friend' +
      '<a href="#fnref:2" rev="footnote" style="margin-left: 6px">&#8617;</a></span></li></ol></div></div>'
    );
  });
